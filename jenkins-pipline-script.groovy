    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                // bat "git clone -b ${params.GIT_BRANCH} ${params.GIT_URL} ."
                checkout([$class: 'GitSCM', 
                    branches: [[name: "${params.GIT_BRANCH}"]], 
                    userRemoteConfigs: [[credentialsId: 'my ssh', url: "${params.GIT_URL}"]]])
                // git branch: 'main', credentialsId: 'my ssh', url: 'git@github.com:nightwish2016/kevin-kong-automation-testing.git'
